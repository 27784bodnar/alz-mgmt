module "avd_core_rule_collection_group" {
  ...
  firewall_policy_rule_collection_group_firewall_policy_id = "module.hub_and_spoke_vnet[0].module.hub_and_spoke_vnet.module.fw_policies["primary"].azurerm_firewall_policy"
